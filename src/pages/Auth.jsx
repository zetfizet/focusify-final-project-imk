          ...
          <div className="auth-card">
            ...
            {tab === 'login' && (
              <form className="auth-body" onSubmit={handleLogin}>
                ...
                {loginError && <div style={{ padding: '10px 12px', background: '#fee', border: '1px solid #fcc', borderRadius: 6, color: '#c33', marginBottom: 12, fontSize: '14px' }}>❌ {loginError}</div>}
                ...
                <button className="btn-submit" type="submit" disabled={loading}>{loading ? '⏳ Signing in...' : 'Sign In to Focusify'}</button>
            ...
            {tab === 'reg' && (
              <form className="auth-body" onSubmit={handleRegister}>
                ...
                {regError && <div style={{ padding: '10px 12px', background: '#fee', border: '1px solid #fcc', borderRadius: 6, color: '#c33', marginBottom: 12, fontSize: '14px' }}>❌ {regError}</div>}
                ...
                <button className="btn-submit" type="submit" disabled={loading}>{loading ? '⏳ Creating account...' : 'Create Free Account'}</button>
